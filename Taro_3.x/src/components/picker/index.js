import Taro, { closeSocket } from '@tarojs/taro'
import React, { Component } from 'react'
import { View, PickerView, PickerViewColumn, ScrollView, Swiper, SwiperItem } from '@tarojs/components'
...
export default class Picker extends Component {
  ...
  componentWillMount = () => {
    this.pageSize = Taro.getApp().$app.pageSize
  }
